...
uint32_t Vmax = 1650;  // ADC input max level Vdd typ. 3.3/2=1.65V, in [mV]
uint32_t Vth = 1500; // Vdd min 3.0V/2=1.5V, in [mV]
...
void setup() {
  ...
  Serial.println("ver.2.0 2022/09/26 Add battery check function, refactoring");
  checkbatt();
  bleKeyboard.begin();
